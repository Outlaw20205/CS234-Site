...
<html>
    ...
    <body>
        ...
        <div class = "w3-container"> 
            <form class="w3-margin w3-center" action="db-country-search.php" method="POST">
                <input type = "radio" name = "search_type" value = "Abr">
                <label for = "Abr">Search an Abbreviation</label>
                ...
                <label for = "abr_text">Country Abr (ISO-3166): </label>
                <input type = "text" name = "abr_text" id = "abr_text"><br>
